...
func templatesModelGotpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/model.gotpl", size: 32526, mode: os.FileMode(420), modTime: time.Unix(1571444284, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

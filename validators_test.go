...
func TestMethodValidateStringInListWithValidString(t *testing.T) {
	...
	Convey("Given I call the method ValidateStringInList with an empty string and autogenerated", t, func() {
		...
		validationError := ValidateStringInList("name", "Alexandre", []string{"Dimitri", "Alexandre", "Antoine"}, true)
	...
	Convey("Given I call the method ValidateStringInList with a unvalid string", t, func() {
		...
		validationError := ValidateStringInList("name", "Alexandre", []string{"Dimitri", "Antoine"}, false)
